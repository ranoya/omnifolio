...
<head>
    ...
    <title>mouseDragged (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="mouseDragged (Processing) | ReferenceDocs">
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <p><strong>mouseDragged()</strong> não recebe nenhuma variável ou valor de entrada.</p>

  <a name="Retorno" class="indice">Retorno</a>
<h3><span class="marca">Retorno</span></h3>

  <p><strong>mouseDragged()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
