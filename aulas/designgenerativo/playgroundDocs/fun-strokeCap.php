...
<head>
    ...
    <title>strokeCap (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="strokeCap (Processing) | ReferenceDocs">
...
<h1>strokeCap()</h1>
  ...
  <p>A função <strong>strokeCap()</strong> define qual o formato da finalização de linhas e contornos desenhados.</p>
...
<h3><span class="marca">Sintaxe</span></h3>
  ...
  <p><strong>strokeCap(<span class="marca">m</span>);</strong></p>
...
<h3><span class="marca">Retorno</span></h3>
  ...
  <p><strong>strokeCap()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-strokeWeight.php');"><strong>strokeWeight()</strong></a></td><td>Define a espessura de contornos e linhas</td>
    </tr>
  </table>
