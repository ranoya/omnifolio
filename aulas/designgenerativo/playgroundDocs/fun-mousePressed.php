...
<head>
    ...
    <title>mousePressed (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="mousePressed (Processing) | ReferenceDocs">
...
<h1>mousePressed()</h1>
  ...
  <p>A função <strong>mousePressed()</strong> é uma função invocada pelo contexto do <strong>Processing</strong> quando um evento específico ocorre: o botão esquerdo do mouse é clicado. Os procedimentos que estiverem estabelecidos dentro desta função serão executados assim que o evento for detectado.</p>

  <p>O click do mouse é dividido em 2 partes: um primeiro momento onde o botão é pressionado, cujos procedimentos são definidos em <strong>mousePressed()</strong>, um segundo momento onde o botão é liberado após o click. Se o tempo entre o pressionar e o liberar for muito rápido e a posição do mouse não se alterar, é invocada a função <a href="javascript:carrega('fun-mouseClicked.php');"><strong>mouseClicked()</strong></a>; se o tempo entre o pressionar e o liberar for mais longo, ou houver uma mudança de posição, a função <a href="javascript:carrega('fun-mouseDragged.php');"><strong>mouseDragged()</strong></a> é invocada, e posteriormente a função <a href="javascript:carrega('fun-mouseReleased.php');"><strong>mouseReleased()</strong></a> quando o botão do mouse for liberado.</p>

  <p>Na ausência de <a href="javascript:carrega('fun-mouseReleased.php');"><strong>mouseReleased()</strong></a>, a função <a href="javascript:carrega('fun-mouseClicked.php');"><strong>mouseClicked()</strong></a> será chamada, caso não haja alteração na posição do mouse.</p>
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <p><strong>mousePressed()</strong> não recebe nenhuma variável ou valor de entrada.</p>

  <a name="Retorno" class="indice">Retorno</a>
<h3><span class="marca">Retorno</span></h3>

  <p><strong>mousePressed()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
