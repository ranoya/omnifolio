...
<head>
    ...
    <title>mouseWheel (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="mouseWheel (Processing) | ReferenceDocs">
...
<h1>mouseWheel()</h1>
  ...
  <p>A função <strong>mouseWheel()</strong> é uma função invocada pelo contexto do <strong>Processing</strong> toda vez que o scroll do mouse é acionado, atribuíndo a uma variável de entrada, do tipo <span class="marca">MouseEvent</span> as propriedades desta ação. Os valores podem ser positivos ou negativos em função da direção do scroll.</p>
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <p><strong>mouseWheel()</strong> recebe uma variável do tipo <span class="marca">MouseEvent</span>, ao qual serão atribuídas valores para as ações do mouse. Esta variável não precisa conter nenhum dado de entrada para <strong>mouseWheel()</strong>.</p>
...
<h3><span class="marca">Retorno</span></h3>
  ...
  <p><strong>mouseWheel()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
