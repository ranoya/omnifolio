...
<head>
    ...
    <title>keyPressed (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="keyPressed (Processing) | ReferenceDocs">
...
<h1>keyPressed()</h1>
  ...
  <p>A função <strong>keyPressed()</strong> é uma função invocada pelo contexto do <strong>Processing</strong> quando qualquer tecla é pressionada no teclado.</p>

  <p>O evento de reconhecimento de uma tecla é dividido em 2 partes: um primeiro momento onde a tecla é pressionada, cujos procedimentos são definidos em <strong>keyPressed()</strong> e um segundo momento onde a tecla é liberada, cujos procedimentos são definidos em <a href="javascript:carrega('fun-keyReleased.php');"><strong>keyReleased()</strong></a>.</p>
