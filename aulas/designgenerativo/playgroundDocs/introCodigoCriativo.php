...
<body>
  ...
  <div id="texto">
  <a name="Guia de programação em código criativo" class="indice">Guia de programação em código criativo</a>
<h1>Guia de programação em código criativo</h1>

  <h2>LINGUAGENS DISPONÍVEIS</h2>

  <p class="choose"><a href="https://www.ranoya.com/aulas/designgenerativo/playgroundDocs/introProcessing.php?theme=neutro&elementos=processing">Processing</a><span style="padding: 10px; color: grey;">P5</span><a href="https://www.ranoya.com/aulas/designgenerativo/playgroundDocs/introSVG.php?theme=neutro&elementos=svg">SVG</a><span style="padding: 10px; color: grey;">D3</span><span style="padding: 10px; color: grey;">Arduino</span><br></p>
  ...
  <p>É possível utilizar diversar linguagens de programação no desenvolvimento do <strong>código criativo</strong>. Por enquanto, este guia compreende apenas a linguagem de programação <a href="https://www.ranoya.com/aulas/designgenerativo/playgroundDocs/introProcessing.php?theme=dgen&elementos=processing">Processing</a> na sua base original em <span class="marca">Java</span>, e está iniciando a documentação das instruções em <a href="https://www.ranoya.com/aulas/designgenerativo/playgroundDocs/introSVG.php?theme=dgen&elementos=svg">SVG</a> e <a href="https://www.ranoya.com/aulas/designgenerativo/playgroundDocs/introP5.php?theme=dgen&elementos=p5">P5</a>.</p>
