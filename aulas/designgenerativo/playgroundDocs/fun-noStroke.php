...
<head>
    ...
    <title>noStroke (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="noStroke (Processing) | ReferenceDocs">
...
<h1>noStroke()</h1>
  ...
  <p>A função <strong>noStroke()</strong> define como nulo o desenho de linhas e contornos, isto é, impede que sejam desenhadas.</p>
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <p><strong>noStroke()</strong> não recebe nenhuma entrada.</p>

  <a name="Retorno" class="indice">Retorno</a>
<h3><span class="marca">Retorno</span></h3>

  <p><strong>noStroke()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-stroke.php');"><strong>stroke()</strong></a></td><td>Define uma cor para linhas e para contorno para formas</td>
    </tr>
  </table>
