...
<head>
    ...
    <title>endShape (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="endShape (Processing) | ReferenceDocs">
...
<h1>endShape()</h1>
  ...
  <p>A função <strong>endShape()</strong> marca o final da construção de um polígono ou superfície, e o desenha na tela. Tudo aquilo que for especificando entre a função <a href="javascript:carrega('fun-beginShape.php');"><strong>beginShape()</strong></a> e ela, será desenhado na tela. A configuração deste polígono ou superfície é realizada por funções assessórias, como <a href="javascript:carrega('fun-stroke.php');"><strong>stroke()</strong></a>, <a href="javascript:carrega('fun-strokeWeight.php');"><strong>strokeWeight()</strong></a> ou <a href="javascript:carrega('fun-fill.php');"><strong>fill()</strong></a></p>
...
<h3><span class="marca">Sintaxe</span></h3>
  ...
  <p><strong>endShape(<span class="optionalattr">modo</span>);</strong></p>
...
<h3><span class="marca">Retorno</span></h3>
  ...
  <p><strong>endShape()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-beginShape.php');"><strong>beginShape()</strong></a></td><td>Inicía a especificação de um polígono ou superfície</td>
    </tr>
    <tr>
