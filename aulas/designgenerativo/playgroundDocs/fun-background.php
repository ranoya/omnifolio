...
<head>
    ...
    <title>background (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="background (Processing) | ReferenceDocs">
...
<h1>background()</h1>
  ...
  <p>A função <strong>background()</strong> apaga e define o fundo para o sketch.</p>
...
<h3><span class="marca">Sintaxe</span></h3>
  ...
  <p><strong>background(<span class="marca">c1</span><span class="optionalattr">,c2</span><span class="optionalattr">,c3</span><span class="optionalattr">,a</span>);</strong><br><strong>background(<span class="marca">imagem</span>);</strong><br><strong>background(<span class="marca">color</span>);</strong></p>
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><span class="marca">imagem</span></td><td>Pimage</td><td>imagem</td><td>arquivo externo</td><td>variável que guarda uma imagem externa carregada por <a href="javascript:carrega('fun-loadImage.php');"><strong>loadImage()</strong></a></td>
    </tr>
    <tr>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-loadImage.php');"><strong>loadImage()</strong></a></td><td>Carrega uma imagem externa e a armazena em uma variável</td>
    </tr>
  </table>
