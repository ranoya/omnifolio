...
<head>
    ...
    <title>pushMatrix (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="pushMatrix (Processing) | ReferenceDocs">
...
<h1>pushMatrix()</h1>
  ...
  <p>A função <strong>pushMatrix()</strong> cria operações na matriz de transformação para serem adicionadas à pilha. Apesar dos conceitos de matriz de transformação, e de pilha, serem complicadas de serem explicadas em poucas linhas, seu uso é bastante simples: a função <strong>pushMatrix()</strong> permite que transformações equivalentes às ferramentas de ampliar/reduzir, girar ou mover das aplicações gráficas como <span class="marca">Adobe Photoshop</span> ou <span class="marca">Adobe Illustrator</span> sejam feitas sobre o desenho construído com código.</p>

  <p>Toda operação feita com <strong>pushMatrix()</strong> precisa ser aplicada com a função <a href="javascript:carrega('fun-popMatrix.php');"><strong>popMatrix()</strong></a>, ou seja, assim que o desenho com alterações em sua escala, angulação ou posicionamento é construído, ele só será efetivamente desenhado quando as operações na matriz forem finalizadas com <a href="javascript:carrega('fun-popMatrix.php');"><strong>popMatrix()</strong></a>.</p>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-popMatrix.php');"><strong>popMatrix()</strong></a></td><td>Finaliza e executa as operações da nova matriz na pilha</td>
    </tr>
    <tr>
