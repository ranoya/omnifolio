...
<head>
    ...
    <title>noFill (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="noFill (Processing) | ReferenceDocs">
...
<h1>noFill()</h1>
  ...
  <p>A função <strong>noFill()</strong> define o preenchimento de formas bidimensionais (polígonos, shapes, elípses, etc.) como vazio.</p>
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <p><strong>noFill()</strong> não recebe nenhuma entrada.</p>

  <a name="Retorno" class="indice">Retorno</a>
<h3><span class="marca">Retorno</span></h3>

  <p><strong>noFill()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-fill.php');"><strong>fill()</strong></a></td><td>Define uma cor de preenchimento para formas</td>
    </tr>
  </table>
