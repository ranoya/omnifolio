...
<head>
    ...
    <title>stroke (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="stroke (Processing) | ReferenceDocs">
...
<h1>stroke()</h1>
  ...
  <p>A função <strong>stroke()</strong> define qual a cor utilizada para desenhar linhas e contornos.</p>
...
<h3><span class="marca">Sintaxe</span></h3>
  ...
  <p><strong>stroke(<span class="marca">c1</span><span class="optionalattr">,c2</span><span class="optionalattr">,c3</span><span class="optionalattr">a</span>);</strong><br><strong>stroke(<span class="marca">color</span>);</strong></p>
...
<h3><span class="marca">Funções associadas</span></h3>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-noStroke.php');"><strong>noStroke()</strong></a></td><td>Define linhas e contornos como nulo, impedindo que sejam desenhadas</td>
    </tr>
  </table>
