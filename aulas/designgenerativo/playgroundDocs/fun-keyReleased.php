...
<head>
    ...
    <title>keyReleased (Processing) | ReferenceDocs</title>
    ...
    <meta property="og:title" content="keyReleased (Processing) | ReferenceDocs">
...
<h1>keyReleased()</h1>
  ...
  <p>A função <strong>keyReleased()</strong> é uma função invocada pelo contexto do <strong>Processing</strong> quando uma tecla é liberada qapós ter sido mantida pressionada por um pequeno intervalo de tempo.</p>

  <p>O evento de reconhecimento de uma tecla é dividido em 2 partes: um primeiro momento onde a tecla é pressionada, cujos procedimentos são definidos em <a href="javascript:carrega('fun-keyPressed.php');"><strong>keyPressed()</strong></a> e um segundo momento onde a tecla é liberada, cujos procedimentos são definidos em <strong>keyReleased()</strong>.</p>
...
<h3><span class="marca">Entradas</span></h3>
  ...
  <p><strong>keyPressed()</strong> não recebe nenhuma variável ou valor de entrada.</p>

  <a name="Retorno" class="indice">Retorno</a>
<h3><span class="marca">Retorno</span></h3>

  <p><strong>keyPressed()</strong> é uma função do tipo <span class="marca">void</span>, e portanto não retorna nenhum valor.</p>
