...
filterselection['website'] = false;
filterselection['presentation'] = false;
filterselection['interface'] = false;
filterselection['games'] = false;
filterselection['design'] = false;
filterselection['logo'] = false;
filterselection['artdirection'] = false;
filterselection['advertising'] = false;
filterselection['personagem'] = false;
filterselection['illustration'] = false;
filterselection['musik'] = false;
filterselection['generativo'] = false;
filterselection['fractal'] = false;
filterselection['render'] = false;
filterselection['arch'] = false;
...
$(document).ready(function () {
  ...
  if ($.parametros('filter')) {
    ...
    AMS_ReQuery({
      cat: 'portfolio',
      render: 'images',
      filter: 'imagem,' + $.parametros('filter'),
      divtarget: '#paineldeprojetos'
    });
