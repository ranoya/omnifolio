...
<head>
    ...
    <title>HTML: div | ReferenceDocs</title>
    ...
    <meta property="og:title" content="HTML: div | ReferenceDocs">
...
<h1><code>&lt;div&gt;</code></h1>
  ...
  <p>A tag <code>&lt;div&gt;</code> cria um bloco genérico para agrupar conteúdos. Ela é equivalente, no grupo de tags de bloco, ao que a tag <a href="javascript:carrega('tag-span');"><code>&lt;span&gt;</code></a> representa no grupo de tags inline/conteúdo. A função da tag <code>&lt;div&gt;</code> é separar os conteúdos do código HTML em divisões de espaço/conjunto, sem qualquer peso semântico.</p>
...
&lt;html&gt;
  &lt;head&gt;
   &lt;style&gt; div { color: white; border: 1px solid white; } &lt;/style&gt;
  &lt;/head&gt;
