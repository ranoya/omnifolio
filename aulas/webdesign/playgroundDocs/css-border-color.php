...
<h1>border-color</h1>
  ...
  <p>O atributo <code>border-color</code> atribui cores para até 4 bordas do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
  ...
  &lt;head&gt;
   &lt;style&gt;
     div { 
         border-width: 5px;
         border-style: solid;
         border-color: red green white cyan;
         color: white;
     }
    &lt;/style&gt;
  &lt;/head&gt;
