...
<body>
  ...
  <a name="border-left-width" class="indice">border-left-width</a>
<h1>border-left-width</h1>

  <p>O atributo <code>border-left-width</code> define a espessura da borda da esquerda (left) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
