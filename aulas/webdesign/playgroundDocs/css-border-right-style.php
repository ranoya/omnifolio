...
<body>
  ...
  <a name="border-right-style" class="indice">border-right-style</a>
<h1>border-right-style</h1>

  <p>O atributo <code>border-right-style</code> define o tipo da borda da direita (right) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
