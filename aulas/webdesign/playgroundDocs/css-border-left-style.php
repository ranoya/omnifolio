...
<body>
  ...
  <a name="border-left-style" class="indice">border-left-style</a>
 <h1>border-left-style</h1>

  <p>O atributo <code>border-left-style</code> define o tipo da borda da esquerda (left) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
