...
<head>
    ...
    <title>CSS: MARGIN | ReferenceDocs</title>
...
<h1>margin</h1>
  ...
  <p>O atributo <code>margin</code> é um shortcut para definir diversas margens (distância do elemento para o elemento conseguinte) ao mesmo tempo, conforme a estrutura de <a href="javascript:carrega('boxmodel.php');">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
...
margin: 20px 30px;
  ...
  <p>O atributo pode receber 1 valor, 2 valores, 3 valores ou 4 valores de dimensionamento em qualquer <a href="javascript:carrega('unidadescss.php');">tipo de medida</a> aceita pelo CSS ou definida através de uma <a href="javascript:carrega('funcoescss.php');"><code>função</code></a>.</p>
...
<p>Para controlar os demais espaçamentos dos elementos HTML, utilizar os atributos:
  ...
  <a href="javascript:carrega('css-padding-right.php');"><code>padding-right</code></a>,
