...
<head>
    ...
    <title>CSS: TOP | ReferenceDocs</title>
...
<body>
  ...
  <a name="top" class="indice">top</a>
<h1>top</h1>

  <p>Através do atributo <code>top</code> é possível definir a posição vertical do elemento em relação a sua borda superior. Se o atributo <a href="javascript:carrega('css-position.php');"><code>position</code></a> for <code>fixed</code>, a posição será dada em relação à janela do navegador; se for <code>absolute</code>, em relação ao topo do documento; e se for <code>relative</code>, relativa ao seu elemento pai que possua também <a href="javascript:carrega('css-position.php');"><code>position</code></a> <code>relative</code>.</p>
...
<h2>Valores</h2>
  ...
  <p><code>top</code> recebe qualquer dimensão aceita pelo CSS, tais como <code>%</code>, <code>vh</code>, <code>vw</code>, <code>em</code>, <code>px</code>, ou mesmo <code>cm</code>.</p>
