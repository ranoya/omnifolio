...
<body>
  ...
  <a name="border-top-style" class="indice">border-top-style</a>
<h1>border-top-style</h1>

  <p>O atributo <code>border-top-style</code> define o tipo da borda de cima (top) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
