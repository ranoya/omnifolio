...
<body>
  ...
  <a name="border-bottom-width" class="indice">border-bottom-width</a>
<h1>border-bottom-width</h1>

  <p>O atributo <code>border-bottom-width</code> define a espessura da borda de baixo (bottom) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
...
border-bottom-width: 10px;
  ...
  <p>O atributo recebe qualquer tipo de <a href="javascript:carrega('unidadescss.php');">medida</a> aceita pelo CSS.</p>
