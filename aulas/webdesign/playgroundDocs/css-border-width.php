...
<body>
 ...
 <h1>border-width</h1>
  ...
  <p>O atributo <code>border-width</code> define espessuras para até quatro bordas do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
...
border-width: 2px 5px 2px 5px;
  ...
  <p>É importante definir o tipo de borda (<a href="javascript:carrega('css-border-style.php');"><code>border-style</code></a>) antes de se atribuír uma espessura.</p> 
