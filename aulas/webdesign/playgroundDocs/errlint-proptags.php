...
<p>Os problemas apresentados envolvem um pouco de conhecimento em CSS, mas estão mais relacionados ao problema da escrita do código. São problemas comuns, que recaem mais sobre a falta de atenção ao se escrevê-lo, do que ao seu desconhecimento. De qualquer maneira, é importante saber identificá-los e corrigí-los. Se você não consegue solucionar estas questões, leia com atenção os documentos de <a href="javascript:carrega('sintaxecss.php');">sintaxe do CSS</a> e sua <a href="javascript:carrega('seletorescss.php');">aplicação</a>.</p>
