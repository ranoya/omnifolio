...
<h1>margin-right</h1>
  ...
  <p>O atributo <code>margin-right</code> define as dimensões da margem esquerda (distância do elemento para o elemento conseguinte), conforme a estrutura de <a href="javascript:carrega('boxmodel.php');">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
