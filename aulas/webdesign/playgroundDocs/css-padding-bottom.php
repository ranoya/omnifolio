...
<body>
  ...
  <a name="padding-bottom" class="indice">padding-bottom</a>
<h1>padding-bottom</h1>

  <p>O atributo <code>padding-bottom</code> define as dimensões do espaçamento interno inferior (distância do elemento para sua própria borda), conforme a estrutura de <a href="javascript:carrega('boxmodel.php');">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
