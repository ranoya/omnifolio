...
<h1>padding</h1>
  ...
  <p>O atributo <code>padding</code> é um shortcut para definir diversos espaçamentos internos (distância do elemento para sua própria borda) ao mesmo tempo, conforme a estrutura de <a href="javascript:carrega('boxmodel.php');">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
