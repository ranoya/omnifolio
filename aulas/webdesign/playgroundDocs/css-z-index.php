...
<head>
    ...
    <title>CSS: Z-INDEX | ReferenceDocs</title>
...
<body>
  ...
  <a name="z-index" class="indice">z-index</a>
<a name="z-index" class="indice">z-index</a>
 <h1>z-index</h1>

  <p>O atributo <code>z-index</code> define a ordem de superposição dos elementos cujo atributo <a href="javascript:carrega('css-position.php');"><code>position</code></a> não seja <code>static</code>. Quanto maior o valor de <code>z-index</code>, mais prioritário ele será. <code>z-index</code> deve ser entendido como a posição do elemento no eixo de profundidade (orgotonal à tela). Quanto maior o valor, mais "alto" o elemento está neste eixo.</p>
...
<h2>Valores</h2>
  ...
  <p><code>z-index</code> recebe um valor numérico arbitrário, sem nenhuma medida ou dimensionamento.</p>
...
&lt;html&gt;
  ...
  &lt;body&gt;
    &lt;div class=&#039;blocoA&#039;&gt;bloco A&lt;/div&gt;
    &lt;div class=&#039;blocoB&#039;&gt;bloco B&lt;/div&gt;
  &lt;/body&gt;
&lt;/html&gt;
</pre>
