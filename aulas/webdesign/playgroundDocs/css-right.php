...
<head>
    ...
    <title>CSS: RIGHT | ReferenceDocs</title>
...
<h1>right</h1>
  ...
  <p>Através do atributo <code>right</code> é possível definir a posição horizontal do elemento em relação a sua borda direita. Se o atributo <a href="javascript:carrega('css-position.php');"><code>position</code></a> for <code>fixed</code>, a posição será dada em relação à janela do navegador; se for <code>absolute</code>, em relação a latral direita do documento; e se for <code>relative</code>, relativa ao seu elemento pai que possua também <a href="javascript:carrega('css-position.php');"><code>position</code></a> <code>relative</code>.</p>
