...
<body>
  ...
  <a name="margin-top" class="indice">margin-top</a>
 <h1>margin-top</h1>

  <p>O atributo <code>margin-top</code> define as dimensões da margem superior (distância do elemento para o elemento conseguinte), conforme a estrutura de <a href="javascript:carrega('boxmodel.php');">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
