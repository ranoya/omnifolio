...
<head>
    ...
    <title>CSS: IMPORT | ReferenceDocs</title>
    ...
    <meta property="og:title" content="CSS: IMPORT | ReferenceDocs">
...
<body>
 ...
 <h1>@import</h1>
  ...
  <p>A diretriz <code>@import</code> carrega um arquivo externo para dentro do CSS, e pode definir condições específicas quanto às dimensões e o substrato onde o documento HTML está sendo exibido para que isso aconteça, exatamente igual à diretriz <a href="javascript:carrega('css-media.php');"><code>@media</code></a>.</p>
