...
<h1>border-right-color</h1>

  <p>O atributo <code>border-right-color</code> define a cor da borda da direita (right) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
