...
<body>
  ...
  <a name="border-left-color" class="indice">border-left-color</a>
<h1>border-left-color</h1>

  <p>O atributo <code>border-left-color</code> define a cor da borda da esquerda (left) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
