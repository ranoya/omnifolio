...
<body>
  ...
  <a name="border-right-width" class="indice">border-right-width</a>
 <h1>border-right-width</h1>

  <p>O atributo <code>border-right-width</code> define a espessura da borda da direita (right) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
