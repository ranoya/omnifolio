...
<body>
  ...
  <a name="border-bottom-style" class="indice">border-bottom-style</a>
 <h1>border-bottom-style</h1>

  <p>O atributo <code>border-bottom-style</code> define o tipo da borda de baixo (bottom) do <a href="javascript:carrega('boxmodel.php');">box model</a>.</p>
