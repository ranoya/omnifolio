...
filterselection['ArtigoCongresso'] = false;
filterselection['ArtigoRevista'] = false;
filterselection['Dissertacao'] = false;
filterselection['Tese'] = false;
filterselection['Livro'] = false;
filterselection['CapituloDeLivro'] = false;
filterselection['Prefacio'] = false;
filterselection['Traducao'] = false;
filterselection['SolangeCoutinho'] = false;
filterselection['HansWaechter'] = false;
filterselection['SilvioCampello'] = false;
filterselection['AliceRocha'] = false;
filterselection['EvaMiranda'] = false;
filterselection['IsabellaAragao'] = false;
filterselection['GuilhermeRanoya'] = false;
filterselection['UltimosCincoAnos'] = false;
    ...
    if ($.parametros('render') == "listalinha") {
        ...
        for (k = 0; k < json.length; k++) {
            if (json[k].titulo.toUpperCase().indexOf(filtratudo) >= 0) {
                ...
                popula = popula + '<p class=\'listatitulopublico\'>' + json[k].autor + ". " + json[k].titulo;
                popula = popula + "</p></div>";
            }
        }
        ...
        for (k = 0; k < json.length; k++) {
            if (json[k].titulo.toUpperCase().indexOf(filtratudo) >= 0) {
                popula = popula + "<div class='listalinha'>";
                popula = popula + '<a class=\'listatitulo\' href=\'' + json[k].link + '\'>' + json[k].autor + ". " + json[k].titulo;
                popula = popula + "</a></div>";
            }
        }
