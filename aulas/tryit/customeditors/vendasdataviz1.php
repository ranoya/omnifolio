...
embed=[options] - changes for embedding (slides | plain)
...
<head>
  ...
  <link REL="SHORTCUT ICON" HREF="https://www.ranoya.com/aulas/tryit/icon.png">
...
<script>
      ...
      function changeContent(data) {
        ...
        iframe.document.write("quantassemanas = 3 + parseInt(Math.random()*6); quantoslivros = 2 + parseInt(Math.random()*3); vendas = new Array(); for (k=0; k < quantassemanas; k++) { vendas[k] = new Array(); for (m=0; m<quantoslivros; m++ ) { vendas[k][m] = parseInt(Math.random()*30); } }");
    ...
    if($.parametros('loadaluno') && $.parametros('loadatv') && $.parametros('loademail') && $.parametros('loaddisciplina')) {
        ...
        console.log("Trabalho de aluno ativado");
          ...
          querysearch['nomealuno'] = unescape($.parametros('loadaluno'));
