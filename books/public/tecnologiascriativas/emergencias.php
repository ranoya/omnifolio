...
?>
        <title>Sistemas Emergentes | O tecido das tecnologias criativas</title>
        <meta property="og:title" content='Introdução | O tecido das tecnologias criativas'>
  		<meta name="description" content="Sistemas Emergentes. Capítulo da versão digital do livro O tecido das tecnologias criativas">
        <meta property="og:description" content="Sistemas Emergentes. Capítulo da versão digital do livro O tecido das tecnologias criativas, do Prof. Guilherme Ranoya">
...
<h1 id="titulocapitulo">Sistemas Emergentes</h1>
...
<div class="slidecut500">
  <iframe src="https://slides.com/ranoya/historiaartegenerativa/embed" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    
</div>
<span class="legenda">Um pouco da história das artes computacionais.</span>
...
<div id="processing">
  ...
  <div id="futurododesign">
		...
		<a target="_blank" href="https://www.ranoya.com/public/futuro/index.php<?php if ($_SESSION['theme']) { echo '?theme=' . $_SESSION['theme']; } ?>#designgenerativo">Detalhes</a><br>
	</div>
