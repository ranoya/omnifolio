...
?>
    ...
    <meta name="description" content="Solicitações | O código HTML, capítulo do livro O tecido das tecnologias criativas">
    <meta name="author" content="Prof. Dr. Guilherme Ranoya">
    
    <meta property="og:title" content="Solicitações | Tecnologias Criativas">
    <meta property="og:description" content="Solicitações | O código HTML, capítulo do livro O tecido das tecnologias criativas">
...
<h1 id='titulocapitulo'>Solicitações</h1>
  ...
  <p>Solicite por aqui a documentação e inclusão de instruções ou procedimentos relacionados ao código HTML.</p>
...
<h2>Instruções / Procedimentos já solicitados</h2>
    <div>
        <div style="width: 100%;"><div id="langtype" style="float: right;"><code>&lt; &gt; HTML</code></div><hr style="width: 100%; clear: both; border: 0;"></hr></div>
        <code>
