...
?>
    <title>pushMatrix | O tecido das tecnologias criativas</title>
    <meta name="description" content="pushMatrix | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="pushMatrix | O tecido das tecnologias criativas">
    <meta property="og:description" content="pushMatrix | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  <div id="texto">
  <a name="pushMatrix()" class="indice">pushMatrix()</a>
<h1 id='titulocapitulo'>pushMatrix()</h1>

  <p>A função <code>pushMatrix()</code> cria operações na matriz de transformação para serem adicionadas à pilha. Apesar dos conceitos de matriz de transformação, e de pilha, serem complicadas de serem explicadas em poucas linhas, seu uso é bastante simples: a função <code>pushMatrix()</code> permite que transformações equivalentes às ferramentas de ampliar/reduzir, girar ou mover das aplicações gráficas como <span class="marca">Adobe Photoshop</span> ou <span class="marca">Adobe Illustrator</span> sejam feitas sobre o desenho construído com código.</p>

  <p>Toda operação feita com <code>pushMatrix()</code> precisa ser aplicada com a função <a href="javascript:carrega('fun-popMatrix.php');"><code>popMatrix()</code></a>, ou seja, assim que o desenho com alterações em sua escala, angulação ou posicionamento é construído, ele só será efetivamente desenhado quando as operações na matriz forem finalizadas com <a href="javascript:carrega('fun-popMatrix.php');"><code>popMatrix()</code></a>.</p>
...
<h2>Funções associadas</h2>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-popMatrix.php');"><code>popMatrix()</code></a></td><td>Finaliza e executa as operações da nova matriz na pilha</td>
    </tr>
    <tr>
