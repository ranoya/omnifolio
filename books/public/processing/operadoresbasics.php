...
?>
    ...
    <meta name="description" content="Operadores | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="Operadores | O tecido das tecnologias criativas">
    <meta property="og:description" content="Operadores | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  Predata_editor_1 =  `<styl` + `e>
  body, html { margin: 0; padding: 0; }
  </sty` + `le>` +
  `<canvas id='pjs' ` + `style='outline: none;'>` + `</canvas>` +
  `<scri`+ `pt src='https://www.ranoya.com/public/dev/processing.min.js'></sc` + `ript><scrip` + `t type='application/processing' data-processing-target='pjs'>` +
  `
  ...
  Postdata_editor_1 = "fill(#cccccc); textSize(18); text('1:', 15, 20); text('2:', 15, 40); fill(#ac2ac6); text('a = ' + a, 40,20); text('b = ' + b, 40,40); noLoop();" + "</scr" + "ipt>";

   Postdata_editor_2 = "fill(#cccccc); textSize(18); text('1:', 15, 20); text('2:', 15, 40);  text('3:', 15, 60);  text('4:', 15, 80);  text('5:', 15, 100);  text('6:', 15, 120);  text('7:', 15, 140);  text('8:', 15, 160); fill(#ac2ac6); text('a = ' + a, 40,20); text('r = ' + r, 40,40); text('v = ' + v, 40,60);  text('b = ' + b, 40,80);  text('c = ' + c, 40,100); text('k = ' + k, 40,120);  text('w = ' + w, 40,140);  text('s = ' + s, 40,160); noLoop();" + "</scr" + "ipt>";
 
    Postdata_editor_3 = Postdata_editor_1;

    Postdata_editor_4 = "fill(#cccccc); textSize(18); text('1:', 15, 20); fill(#ac2ac6); text('interruptor = ' + interruptor, 40,20); noLoop();" + "</scr" + "ipt>";

     Postdata_editor_5 = "fill(#cccccc); textSize(18); text('1:', 15, 20); fill(#ac2ac6); text('interruptor = ' + interruptor, 40,20); noLoop();" + "</scr" + "ipt>";
