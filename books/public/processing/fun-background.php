...
?>
    <title>Background | O tecido das tecnologias criativas</title>
    <meta name="description" content="Background | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="Background | O tecido das tecnologias criativas">
    <meta property="og:description" content="Background | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  <div id="texto">
  <a name="background()" class="indice">background()</a>
<h1 id='titulocapitulo'>background()</h1>

  <p>A função <code>background()</code> apaga e define o fundo para o sketch.</p>
...
<h2>Sintaxe</h2>
  ...
  <p><code>background(<span class="marca">c1</span><span class="optionalattr">,c2</span><span class="optionalattr">,c3</span><span class="optionalattr">,a</span>);</code><br><code>background(<span class="marca">imagem</span>);</code><br><code>background(<span class="marca">color</span>);</code></p>
...
<h2>Entradas</h2>
  ...
  <table>
    ...
    <tr>
      <td><span class="marca">imagem</span></td><td>Pimage</td><td>imagem</td><td>arquivo externo</td><td>variável que guarda uma imagem externa carregada por <a href="javascript:carrega('fun-loadImage.php');"><code>loadImage()</code></a></td>
    </tr>
    <tr>
...
<h2>Funções associadas</h2>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-loadImage.php');"><code>loadImage()</code></a></td><td>Carrega uma imagem externa e a armazena em uma variável</td>
    </tr>
  </table>
