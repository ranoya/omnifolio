...
?>
    <title>mousePressed | O tecido das tecnologias criativas</title>
    <meta name="description" content="mousePressed | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="mousePressed | O tecido das tecnologias criativas">
    <meta property="og:description" content="mousePressed | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  <div id="texto">
  <a name="mousePressed()" class="indice">mousePressed()</a>
<h1 id='titulocapitulo'>mousePressed()</h1>

  <p>A função <code>mousePressed()</code> é uma função invocada pelo contexto do <span class="marca">Processing</span> quando um evento específico ocorre: o botão esquerdo do mouse é clicado. Os procedimentos que estiverem estabelecidos dentro desta função serão executados assim que o evento for detectado.</p>

  <p>O click do mouse é dividido em 2 partes: um primeiro momento onde o botão é pressionado, cujos procedimentos são definidos em <code>mousePressed()</code>, um segundo momento onde o botão é liberado após o click. Se o tempo entre o pressionar e o liberar for muito rápido e a posição do mouse não se alterar, é invocada a função <a href="javascript:carrega('fun-mouseClicked.php');"><code>mouseClicked()</code></a>; se o tempo entre o pressionar e o liberar for mais longo, ou houver uma mudança de posição, a função <a href="javascript:carrega('fun-mouseDragged.php');"><code>mouseDragged()</code></a> é invocada, e posteriormente a função <a href="javascript:carrega('fun-mouseReleased.php');"><code>mouseReleased()</code></a> quando o botão do mouse for liberado.</p>
...
<h2>Entradas</h2>
  ...
  <p><code>mousePressed()</code> não recebe nenhuma variável ou valor de entrada.</p>

  <a name="Retorno" class="indice">Retorno</a>
<h2>Retorno</h2>

  <p><code>mousePressed()</code> é uma função do tipo <code>void</code>, e portanto não retorna nenhum valor.</p>
