...
?>
    <title>stroke | O tecido das tecnologias criativas</title>
    <meta name="description" content="stroke | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="stroke | O tecido das tecnologias criativas">
    <meta property="og:description" content="stroke | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  <div id="texto">
  <a name="stroke()" class="indice">stroke()</a>
<h1 id='titulocapitulo'>stroke()</h1>

  <p>A função <code>stroke()</code> define qual a cor utilizada para desenhar linhas e contornos.</p>
...
<h2>Sintaxe</h2>
  ...
  <p><code>stroke(<span class="marca">c1</span><span class="optionalattr">,c2</span><span class="optionalattr">,c3</span><span class="optionalattr">a</span>);</code><br><code>stroke(<span class="marca">color</span>);</code></p>
...
<h2>Funções associadas</h2>
  ...
  <table>
    ...
    <tr>
      <td><a href="javascript:carrega('fun-noStroke.php');"><code>noStroke()</code></a></td><td>Define linhas e contornos como nulo, impedindo que sejam desenhadas</td>
    </tr>
  </table>
