...
?>
    <title>color | O tecido das tecnologias criativas</title>
    <meta name="description" content="color | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="color | O tecido das tecnologias criativas">
    <meta property="og:description" content="color | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  <div id="texto">
  <a name="color()" class="indice">color()</a>
<h1 id='titulocapitulo'>color()</h1>

  <p>A função <code>color()</code> define uma cor para que seja armazenada em uma variável do tipo <span class="marca">color</span>.</p>
...
<h2>Sintaxe</h2>
  ...
  <p><code>color(<span class="marca">c1</span><span class="optionalattr">,c2</span><span class="optionalattr">,c3</span><span class="optionalattr">,a</span>);</code></p>
...
<h2>Retorno</h2>
  ...
  <p><code>color()</code> retorna um objeto do tipo <span class="marca">color</span>, e portanto precisa ser armazenado em uma variável do tipo <span class="marca">color</span>, ou ser usado como dado por uma função que recebe um dado tipo <span class="marca">color</span>.</p>

  <a name="Observações" class="indice">Observações</a>
<h2>Observações</h2>

  <p><code>color()</code> recebe valores em formatos diferentes, e os resolve conforme são dados. Se apenas um valor <span class="marca">float</span> for especificado, ela interpretará que se trata de uma escala de cinzas; se um valor hexadecimal for especificado, ela interpretará que se trata de um registro RGB; se 2 valores forem especificados, ela interpretará que se trata de uma escala de cinzas com transparência; se 3 valores forem especificados, ela recorrerá ao que for definido por <a href="javascript:carrega('fun-colorMode.php');"><code>colorMode()</code></a> para interpretá-los; se um quarto valor for especificado, ela o interpretará como o canal alpha (transparência).</p>
