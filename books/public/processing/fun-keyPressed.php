...
?>
    <title>keyPressed | O tecido das tecnologias criativas</title>
    <meta name="description" content="keyPressed | O código Processing, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="keyPressed | O tecido das tecnologias criativas">
    <meta property="og:description" content="keyPressed | O código Processing, capítulo do livro O tecido das tecnologias criativas">    
...
<body>
  ...
  <div id="texto">
  <a name="keyPressed()" class="indice">keyPressed()</a>
<h1 id='titulocapitulo'>keyPressed()</h1>

  <p>A função <code>keyPressed()</code> é uma função invocada pelo contexto do <span class="marca">Processing</span> quando qualquer tecla é pressionada no teclado.</p>

  <p>O evento de reconhecimento de uma tecla é dividido em 2 partes: um primeiro momento onde a tecla é pressionada, cujos procedimentos são definidos em <code>keyPressed()</code> e um segundo momento onde a tecla é liberada, cujos procedimentos são definidos em <a href="javascript:carrega('fun-keyReleased.php');"><code>keyReleased()</code></a>.</p>
