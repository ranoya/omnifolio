...
<body>
 ...
 <h1 id='titulocapitulo'>border-bottom-style</h1>

  <p>O atributo <code>border-bottom-style</code> define o tipo da borda de baixo (bottom) do <a href="boxmodel.php">box model</a>.</p>
