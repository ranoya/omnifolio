...
<body>
  ...
  <a name="border-style" class="indice">border-style</a>
<h1 id='titulocapitulo'>border-style</h1>

  <p>O atributo <code>border-style</code> atribui tipos para até 4 bordas do <a href="boxmodel.php">box model</a>.</p>
