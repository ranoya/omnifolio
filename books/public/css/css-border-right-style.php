...
<h1 id='titulocapitulo'>border-right-style</h1>

  <p>O atributo <code>border-right-style</code> define o tipo da borda da direita (right) do <a href="boxmodel.php">box model</a>.</p>
