...
<h1 id='titulocapitulo'>border-bottom-width</h1>

  <p>O atributo <code>border-bottom-width</code> define a espessura da borda de baixo (bottom) do <a href="boxmodel.php">box model</a>.</p>
...
<h2 style="width: 100%; clear: both;"></h2>
  ...
  <p>O atributo recebe qualquer tipo de <a href="unidadescss.php">medida</a> aceita pelo CSS.</p>
