...
<body>
 ...
 <h1 id='titulocapitulo'>padding-top</h1>

  <p>O atributo <code>padding-top</code> define as dimensões do espaçamento interno superior (distância do elemento para sua própria borda), conforme a estrutura de <a href="boxmodel.php">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
