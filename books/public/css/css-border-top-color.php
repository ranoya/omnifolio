...
<body>
  ...
  <a name="border-top-color" class="indice">border-top-color</a>
<h1 id='titulocapitulo'>border-top-color</h1>

  <p>O atributo <code>border-top-color</code> define a cor da borda de cima (top) do <a href="boxmodel.php">box model</a>.</p>
