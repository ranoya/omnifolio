...
?>
    <title>CSS: Cores | O tecido das tecnologias criativas</title>
    <meta name="description" content="CSS: Cores | O código CSS, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="CSS: Cores | O tecido das tecnologias criativas">
    <meta property="og:description" content="CSS: Cores | O código CSS, capítulo do livro O tecido das tecnologias criativas">    
</head>
<body>
...
<h1 id='titulocapitulo'>Registro de cores</h1>
...
<h2>Valores hexadecimais</h2>
  ...
  <div>
    <table style="border: 0;">
      <tr>
        <td style="border: 0; width: 20px; height: 20px; background-color: #000000;">
        </td>
        <td style="border: 0;">&nbsp;#000000 
        </td>
      </tr>

       <tr>
        <td style="border: 0; width: 20px; height: 20px; background-color: #888888;">
        </td>
        <td style="border: 0;">&nbsp;#888888 
        </td>
      </tr>

       <tr>
        <td style="border: 0; width: 20px; height: 20px; background-color: #FFFFFF;">
        </td>
        <td style="border: 0;">&nbsp;#FFFFFF 
        </td>
      </tr>

       <tr>
        <td style="border: 0; width: 20px; height: 20px; background-color: #FF0000;">
        </td>
        <td style="border: 0;">&nbsp;#FF0000 
        </td>
      </tr>

       <tr>
        <td style="border: 0; width: 20px; height: 20px; background-color: #00FF00;">
        </td>
        <td style="border: 0;">&nbsp;#00FF00 
        </td>
      </tr>

       <tr>
        <td style="border: 0; width: 20px; height: 20px; background-color: #0000FF;">
        </td>
        <td style="border: 0;">&nbsp;#0000FF 
        </td>
      </tr>
...
<table style="border: none transparent 0; width: 100%;"> 
  <tr> 
  <th>Nome</th> 
  <th>Hexadecimal</th>
  <th>RGB</th> 
  ...
  <a name="Funções" class="indice">Funções CSS e transparências</a>
<h2>Funções CSS e transparências</h2>

  <p>A terceira maneira de se especificar uma cor no CSS é através das <a href="funcoescss.php"><code>funções</code></a> <code>rgb()</code>, <code>rgba()</code>, <code>hsl()</code> e <code>hsla()</code>. As <a href="funcoescss.php"><code>funções</code></a> de CSS realizam operações simples de programação no CSS, e estas funções convertem registros RGB ou HSL para a codificação hexadecimal.</p>
...
<h2 style="border: 0; width: 100%; clear: both;"></h2>

<a name="Paleta e variáveis" class="indice">Paleta e variáveis</a>
<h2>Paleta e variáveis</h2>

<p>Como o uso das cores é recorrente em um código, e utilizamos sempre um conjunto pequeno de cores selecionadas para compor uma interface/layout, é recomendável estabelecer uma paleta de cores e atribuí-la a um conjunto de variáveis acessadas através da <a href="funcoescss.php"><code>função</code></a> <code>var()</code>. Esta é uma boa prática para um código CSS de fácil manutenção e mais inteligível.</p>

<p>Para declarar variáveis no CSS, criamos um atributo na raíz dos elementos <code>:root</code>. Para acessá-las, usamos a <a href="funcoescss.php"><code>função</code></a> <code>var()</code>:</p>

<table style="border: none transparent 0; width: 100%;">
  <tr style="border: none transparent 0;"><td colspan=2 style="border: none transparent 0;">
<a name="variaveis" class="indice">variáveis</a>
<h3><code>var(nome, [valor na ausência da variável])</code></h3></td></tr>
 ...
 <a name="Usovar" class="indice">Uso de variáveis</a>
<h3>Uso</h3>
