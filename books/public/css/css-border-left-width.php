...
<h1 id='titulocapitulo'>border-left-width</h1>

  <p>O atributo <code>border-left-width</code> define a espessura da borda da esquerda (left) do <a href="boxmodel.php">box model</a>.</p>
