...
<h1 id='titulocapitulo'>border-left-color</h1>

  <p>O atributo <code>border-left-color</code> define a cor da borda da esquerda (left) do <a href="boxmodel.php">box model</a>.</p>
