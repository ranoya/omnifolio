...
<h1 id='titulocapitulo'>padding-left</h1>

  <p>O atributo <code>padding-left</code> define as dimensões do espaçamento interno esquerdo (distância do elemento para sua própria borda), conforme a estrutura de <a href="boxmodel.php">box model</a> que compõe cada elemento HTML na tela do navegador.</p>
