...
<body>
 ...
 <h1 id='titulocapitulo'>border-left-style</h1>

  <p>O atributo <code>border-left-style</code> define o tipo da borda da esquerda (left) do <a href="boxmodel.php">box model</a>.</p>
