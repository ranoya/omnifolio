...
<body>
  ...
  <a name="border-right" class="indice">border-right</a>
<h1 id='titulocapitulo'>border-right</h1>

  <p>O atributo <code>border-right</code> é um shortcut para definir diversas propriedades da borda direita (right) ao mesmo tempo; ele define a espessura, cor e tipo da borda de uma só vez.</p>
