...
<body>
 ...
 <h1 id='titulocapitulo'>border-right-width</h1>

  <p>O atributo <code>border-right-width</code> define a espessura da borda da direita (right) do <a href="boxmodel.php">box model</a>.</p>
