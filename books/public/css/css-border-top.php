...
<body>
  ...
  <a name="border-top" class="indice">border-top</a>
<h1 id='titulocapitulo'>border-top</h1>

  <p>O atributo <code>border-top</code> é um shortcut para definir diversas propriedades da borda de cima (top) ao mesmo tempo; ele define a espessura, cor e tipo da borda de uma só vez.</p>
