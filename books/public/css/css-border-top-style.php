...
<h1 id='titulocapitulo'>border-top-style</h1>

  <p>O atributo <code>border-top-style</code> define o tipo da borda de cima (top) do <a href="boxmodel.php">box model</a>.</p>
