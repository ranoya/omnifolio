...
<body>
  ...
  <a name="border-bottom" class="indice">border-bottom</a>
<h1 id='titulocapitulo'>border-bottom</h1>

  <p>O atributo <code>border-bottom</code> é um shortcut para definir diversas propriedades da borda de baixo (bottom) ao mesmo tempo; ele define a espessura, cor e tipo da borda de uma só vez.</p>
