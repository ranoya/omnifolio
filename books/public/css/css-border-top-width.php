...
<body>
  ...
  <a name="border-top-width" class="indice">border-top-width</a>
 <h1 id='titulocapitulo'>border-top-width</h1>

  <p>O atributo <code>border-top-width</code> define a espessura da borda de cima (top) do <a href="boxmodel.php">box model</a>.</p>
