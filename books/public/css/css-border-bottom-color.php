...
<h1 id='titulocapitulo'>border-bottom-color</h1>

  <p>O atributo <code>border-bottom-color</code> define a cor da borda de baixo (bottom) do <a href="boxmodel.php">box model</a>.</p>
