...
?>
    ...
    <meta name="description" content="Variáveis | O código P5, capítulo do livro O tecido das tecnologias criativas">
    <meta property="og:title" content="Variáveis | O tecido das tecnologias criativas">
    <meta property="og:description" content="Variáveis | O código P5, capítulo do livro O tecido das tecnologias criativas">    
...
TodosEditoresPre = "<sty" + "le>body, html { margin: 0; padding: 0; } body{ font-family: courrier, monospace; color: #ac2ac6; } span { color: #cccccc; }</s" + "tyle><scr" + "ipt>ln = 1; function println(d) { document.write('<span>' + ln + ': </span>' + d + '<br>'); ln++; }";
  ...
  <div id="texto">
  <a name="variaveis" class="indice">Variáveis no P5</a>
<h1 id='titulocapitulo'>Variáveis no Javascript/P5</h1>
...
<h2>Variáveis tipadas e não tipadas</h2>
  ...
  <p>Em <a href="../javascript">Javascript</a>, e consequentemente em P5, isto é feito com uma instrução do tipo <code>var x = <span class="marca">10</span>;</code>, que poderia ser dividida em duas instruções separadas, sendo a primeira <code>var x;</code>, e a segunda <code>x = <span class="marca">10</span>;</code>.</p>
...
<p>Apesar de P5/<a href="../javascript">Javascript</a> ser uma <span class="marca">linguagem não-tipada</span>, as variáveis possuem sim tipologias. Há dados numéricos que são constituídos por números inteiros; há dados númericos constituídos por frações; há dados binários (<code>booleanos</code>), constituídos por valores <code>true</code> ou <code>false</code>, e há dados do tipo <code>String</code>, isto é, constituído por sequências de caracteres (palavras, textos, etc.). <a href="../javascript">Javascript</a> define a tipologia do dado na memória por inferência (conforme o programador atribui um valor a ela).</p>
